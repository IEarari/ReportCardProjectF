...
public class TenGradeArrayAdapter extends ArrayAdapter<TenGradeArray> {
    private static final String LOG_TAG = TenGradeArrayAdapter.class.getSimpleName();

    public TenGradeArrayAdapter(Activity context, ArrayList<TenGradeArray> Word) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            ...
            TenGradeArray currentWord = getItem(position);

...
public class ElevenGradeArrayAdapter extends ArrayAdapter<ElevenGradeArray> {
    private static final String LOG_TAG = ElevenGradeArrayAdapter.class.getSimpleName();

    public ElevenGradeArrayAdapter(Activity context, ArrayList<ElevenGradeArray> Word) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            ...
            ElevenGradeArray currentWord = getItem(position);
